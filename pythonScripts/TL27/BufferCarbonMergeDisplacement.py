...
buffer_distance = 50
carbon_depth = 50
carbongdf = gpd.read_file(f'/Users/evanthaler/Documents/Projects/permafrost/permafrostCarbon/FinalCleanedFiles/gpkgs/TL27_TotalSoilStocksSlopes_PerCore_{carbon_depth}_slope.gpkg')
dispgdf = gpd.read_file('/Users/evanthaler/Documents/Projects/permafrost/permafrostCarbon/displacement/TL27Displacement2022_wSlope.gpkg')
...
carbon_out = carbon_out.drop(columns=[
       'geometry', 'SampleLocationName_right',],axis=1)
carbon_out = carbon_out.dropna()

carbon_out = carbon_out[carbon_out.Total_C_stock_kg_m2_0to50cm<40]
carbon_out['mean_disp_rate'] = carbon_out['mean_disp_rate']/100
carbon_out.to_csv('/Users/evanthaler/Documents/Projects/permafrost/permafrostCarbon/FinalCleanedFiles/wDisplacement/TL27StocksDisplacement.csv')
######################################
...
plt.savefig('/Users/evanthaler/Documents/Projects/permafrost/permafrostCarbon/figs/TL27_SOCStock_Displacement.jpg',dpi=300)
plt.show()

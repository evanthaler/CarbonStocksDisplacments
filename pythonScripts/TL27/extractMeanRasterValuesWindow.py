...
def getValuesinWindow(pFile,wd,outFile,outGPKG,XVALUE,YVALUE,sitename='SampleLocationName'):
    '''
    ...
    df[XVALUE]=np.array(xc);df[YVALUE]=np.array(yc)
    merged = pd.merge(posFile, df, on=[XVALUE, YVALUE])
    merged = merged.drop_duplicates()
    merge_gdf = gpd.GeoDataFrame(merged,geometry=gpd.points_from_xy(merged[XVALUE],merged[YVALUE]),crs='epsg:32603')
    merged.to_csv(outFile)
    merge_gdf.to_file(outGPKG)

# getValuesinWindow(pFile='/Users/evanthaler/Documents/Projects/permafrost/permafrostCarbon/displacement/TL27Displacement2022.csv',
#                     wd='/Users/evanthaler/Documents/Projects/permafrost/permafrostCarbon/Rasters/TL27/raster2add',
#                     outFile='/Users/evanthaler/Documents/Projects/permafrost/permafrostCarbon/displacement/TL27Displacement2022_wSlope.csv',
#                     outGPKG='/Users/evanthaler/Documents/Projects/permafrost/permafrostCarbon/displacement/TL27Displacement2022_wSlope.gpkg',
#                     XVALUE='Easting [m]',
#                     YVALUE='Northing [m]',
#                     sitename='SampleLocationName')
for d in [40,50,60,100]:
    getValuesinWindow(pFile=f'/Users/evanthaler/Documents/Projects/permafrost/permafrostCarbon/FinalCleanedFiles/TL27/TL27_TotalSoilStocks_PerCore_{d}cm.csv',
                    wd='/Users/evanthaler/Documents/Projects/permafrost/permafrostCarbon/Rasters/TL27/raster2add',
                    outFile=f'/Users/evanthaler/Documents/Projects/permafrost/permafrostCarbon/FinalCleanedFiles/TL27/TL27_TotalSoilStocks_PerCore_{d}cm_slope.csv',
                    outGPKG=f'/Users/evanthaler/Documents/Projects/permafrost/permafrostCarbon/FinalCleanedFiles/gpkgs/TL27_TotalSoilStocksSlopes_PerCore_{d}_slope.gpkg',
                    XVALUE='X',
                    YVALUE='Y')
